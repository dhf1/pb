...
<link href="/static/admin_css/css.css" rel="stylesheet" type="text/css">
      ...
      <table width="180" border="0" cellpadding="0" cellspacing="0" bgcolor="C9DEFA" >
        ...
        <tr>
          <td height="40" onMouseOver='this. background="/static/images/left2.gif"' onMouseOut='this. background="/static/images/left1.gif"' background="/static/images/left1.gif" ><a href="/admin/setting_friendship" class="left3">友情链接管理</a></td>
        </tr>
      </table>
      </td>
...
<iframe src="/admin/web3" name="sina_roll" width="98%" marginwidth="0" height="97%" marginheight="10" scrolling="Yes" frameborder="Yes" id="sina_roll" border="10"></iframe>
    </td>
  </tr>
</table>
