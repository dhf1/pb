...
<tr>
    ...
    <td align="left" valign="bottom" class="white"><table height="30" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="56" align="center"background="/static/images/menu02.gif"><a href="/admin/manager" class="left2">用户</a></td>
...
<link href="/static/admin_css/css.css" rel="stylesheet" type="text/css">
      ...
      <table width="200" height="45" border="0" cellpadding="0" cellspacing="0" background="/static/images/nzsoft_14.gif" id="1">
        <tr> <td width="55" align="center">&nbsp;</td>
          <td class="left14">用户管理</td>
        </tr>
      </table>
      <table width="180" border="0" cellpadding="0" cellspacing="0" bgcolor="C9DEFA" >
        <tr>
          <td height="40" onMouseOver='this. background="/static/images/left2.gif"' onMouseOut='this. background="/static/images/left1.gif"' background="/static/images/left1.gif" ><a href="/admin/manager" class="left3">管理用户</a></td>
        </tr>
      </table>
      </td>
...
<iframe src="/admin/get_adminList" name="sina_roll" width="98%" marginwidth="0" height="97%" marginheight="10" scrolling="Yes" frameborder="Yes" id="sina_roll" border="10"></iframe>
    </td>
  </tr>
</table>
