...
<tr>
    <td width="200" valign="top"><a href="/admin/index"></a><a href="manage_web.asp"><img src="/static/images/logo.jpg" alt="后台标识" border="0"></a></td>
    <td align="left" valign="bottom" class="white"><table height="30" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="56" align="center"background="/static/images/menu02.gif"><a href="/admin/information" class="left2">信息</a></td>		
...
<link href="/static/admin_css/css.css" rel="stylesheet" type="text/css">
      ...
      <table width="200" height="45" border="0" cellpadding="0" cellspacing="0" background="/static/images/nzsoft_14.gif" id="1">
        <tr> <td width="55" align="center">&nbsp;</td>
          <td class="left14">信息管理</td>
        </tr>
      </table>
      <table width="180" border="0" cellpadding="0" cellspacing="0" bgcolor="C9DEFA" >
        <tr>
           <td height="40" onMouseOver='this. background="/static/images/left2.gif"' onMouseOut='this. background="/static/images/left1.gif"' background="/static/images/left1.gif" ><a href="/admin/add_article" class="left3">添加新文章</a></td>
        </tr>
        <tr>
           <td height="40" onMouseOver='this. background="/static/images/left2.gif"' onMouseOut='this. background="/static/images/left1.gif"' background="/static/images/left1.gif" ><a href="/admin/category_manage" class="left3">栏目类别管理</a></td>
        </tr>
        <tr>
           <td height="40" onMouseOver='this. background="/static/images/left2.gif"' onMouseOut='this. background="/static/images/left1.gif"' background="/static/images/left1.gif" ><a href="/admin/manage_by_class" class="left3">按类管理信息</a></td>
        </tr>
        <tr>
           <td height="40" onMouseOver='this. background="/static/images/left2.gif"' onMouseOut='this. background="/static/images/left1.gif"' background="/static/images/left1.gif" ><a href="/admin/all_information" class="left3">管理所有信息</a></td>
        </tr>
      </table>
      </td>
...
<iframe src="/admin/get_categoryResultList/2" name="sina_roll" width="98%" marginwidth="0" height="97%" marginheight="10" scrolling="Yes" frameborder="Yes" id="sina_roll" border="10"></iframe>
    </td>
  </tr>
</table>
